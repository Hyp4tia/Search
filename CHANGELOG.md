...
- An extension package that carries a symbolic link is refused at install, the rewriting of its pages no longer follows one, and a manifest path that points outside its own folder is left alone.
### Fixed
